...
def train(model, model_name, x_test, x_train, y_test, y_train, win_len, batch_size, epochs, folder_name= "trained_models"):
    """
    ...
    history = model.fit_generator(train_generator,
                                  epochs=epochs,
                                  steps_per_epoch=10,
                                  validation_data=(test_set[0], test_set[1]),verbose=1)
